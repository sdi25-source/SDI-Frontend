      ...
      var s = function (i) {
        for (var n in i)
          Object.prototype.hasOwnProperty.call(i, n) &&
            (t && '[object Object]' === Object.prototype.toString.call(i[n]) ? (e[n] = o(!0, e[n], i[n])) : (e[n] = i[n]));
      };
      i < n;
      i++
    ) {
              ...
              -1 !== ['input', 'select', 'textarea', 'button', 'a'].indexOf(t)
                ...
                : (e.preventDefault(),
                  (e.target === this.el || ('img' !== t && g(e.target, '.gslide-inline'))) &&
                    ((this.active = !0), this.el.classList.add('dragging'), (this.dragContainer = g(e.target, '.ginner-container'))));
            }
          },
        },
        {
    ...
    var t,
      ...
      q = new U(X, {
        ...
        pinch: function (e) {
          ...
          var t = m * e.zoom;
          if (((S = !0), t <= 1))
            return (S = !1), (t = 1), (k = null), (C = null), (w = null), (T = null), void v.setAttribute('style', '');
