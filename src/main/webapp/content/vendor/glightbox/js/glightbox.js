  ...
  function slideVideo(slide, data, index, callback) {
    ...
    injectAssets(this.settings.plyr.js, 'Plyr', function () {
      ...
      var placeholder = customPlaceholder
        ? customPlaceholder
        : createHTML(
            '<div id="'.concat(videoID, '" data-plyr-provider="').concat(provider, '" data-plyr-embed-id="').concat(url, '"></div>'),
          );
        ...
        value: function resize() {
          ...
          if (image) {
            if (winWidth <= 768) {
              ...
              var maxHeightValue =
                (_slideTriggerNode$get = slideTriggerNode.getAttribute('data-height')) !== null && _slideTriggerNode$get !== void 0
