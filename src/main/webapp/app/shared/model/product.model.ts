...
import type { IClientCertification } from '@/shared/model/client-certification.model.ts';
...
export interface IProduct {
  ...
  certifications?: IClientCertification[] | null;
}
...
export class Product implements IProduct {
  constructor(
    ...
    public certifications?: IClientCertification[] | null,
  ) {}
}
