    ...
    <div class="card" v-if="moduleDeployements && viewMode === 'list'">
      <div class="table-responsive">
        <table class="table table-hover mb-0" aria-describedby="moduleDeployements">
          ...
          <tbody>
            <tr
              v-for="moduleDeployement in paginatedModuleDeployements"
              :key="moduleDeployement.id"
              data-cy="entityTable"
              class="align-middle"
            >
              <td>
                ...
                <div class="module-deployement-info">
                  ...
                  <div class="info-row">
                    ...
                    <span class="info-value">
                      <router-link
                        v-if="moduleDeployement.moduleVersion"
                        :to="{ name: 'ModuleVersionView', params: { moduleVersionId: moduleDeployement.moduleVersion.id } }"
                      >
                        {{ moduleDeployement.moduleVersion.version }}
                      </router-link>
                      <span v-else>-</span>
                  ...
                  <div class="info-row">
                    ...
                    <span class="info-value">
                      <router-link
                        v-if="moduleDeployement.productDeployementDetail"
                        :to="{
                          name: 'ProductDeployementDetailView',
                          params: { productDeployementDetailId: moduleDeployement.productDeployementDetail.id },
                        }"
