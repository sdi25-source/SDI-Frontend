...
describe('Service Tests', () => {
  describe('Domaine Service', () => {
    ...
    beforeEach(() => {
      ...
      elemDefault = new Domaine(123, 'AAAAAAA', currentDate, currentDate, 'AAAAAAA');
    });
    ...
    describe('Service methods', () => {
      ...
      it('should not create a Domaine', async () => {
      ...
      it('should not update a Domaine', async () => {
      ...
      it('should partial update a Domaine', async () => {
        const patchObject = { ...new Domaine() };
      ...
      it('should not partial update a Domaine', async () => {
      ...
      it('should not return a list of Domaine', async () => {
        axiosStub.get.rejects(error);
      ...
      it('should not delete a Domaine', async () => {
