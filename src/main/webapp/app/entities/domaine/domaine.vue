        ...
        <table class="table table-hover mb-0">
          ...
          <tbody>
            <tr v-if="showAddRow" class="align-middle new-row">
              <td>
                <input v-model="newDomaine.name" type="text" class="form-control-borderless" placeholder="Name" />
              </td>
              <td>
                <input v-model="newDomaine.notes" type="text" class="form-control-borderless" placeholder="Notes" />
              </td>
