<template>
  <div>
    <h2 id="page-heading" data-cy="CertificationHeading">
      ...
      <div class="d-flex justify-content-end">
        <button class="btn btn-info mr-2" @click="handleSyncList" :disabled="isFetching">
          ...
          <span v-text="t$('sdiFrontendApp.certification.home.refreshListLabel')"></span>
        </button>
        <router-link :to="{ name: 'CertificationCreate' }" custom v-slot="{ navigate }">
          ...
          >
            ...
            <span v-text="t$('sdiFrontendApp.certification.home.createLabel')"></span>
          </button>
        </router-link>
      </div>
    </h2>
    ...
    <div class="alert alert-warning" v-if="!isFetching && certifications && certifications.length === 0">
      <span v-text="t$('sdiFrontendApp.certification.home.notFound')"></span>
    </div>
      ...
      <table class="table table-striped" aria-describedby="certifications">
        <thead>
          <tr>
            ...
            <th scope="row"><span v-text="t$('sdiFrontendApp.certification.name')"></span></th>
            <th scope="row"><span v-text="t$('sdiFrontendApp.certification.description')"></span></th>
            <th scope="row"><span v-text="t$('sdiFrontendApp.certification.createDate')"></span></th>
            <th scope="row"><span v-text="t$('sdiFrontendApp.certification.updateDate')"></span></th>
        ...
        <tbody>
          <tr v-for="certification in certifications" :key="certification.id" data-cy="entityTable">
            ...
            <td>{{ certification.createDate }}</td>
    ...
    <b-modal ref="removeEntity" id="removeEntity">
      ...
      <div class="modal-body">
        <p id="jhi-delete-certification-heading" v-text="t$('sdiFrontendApp.certification.delete.question', { id: removeId })"></p>
      </div>
