            ...
            <tr v-for="client in paginatedClients" :key="client.id" data-cy="entityTable" class="align-middle">
              ...
              <td class="text-center">
                <div class="action-icons">
                  ...
                  <!--                    <div class="icon-container edit-container" @click="navigate" title="Modifier">-->
                  <!--                      <svg-->
                  <!--                        xmlns="http://www.w3.org/2000/svg"-->
                  <!--                        width="16"-->
                  <!--                        height="16"-->
                  ...
                  <router-link :to="{ name: 'ClientView', params: { clientId: client.id } }" custom v-slot="{ navigate }">
                    <div class="icon-container view-container" @click="navigate" title="Voir">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="26"
                        height="26"
          ...
          <div class="card h-100 client-card">
            <div class="card-header d-flex justify-content-between align-items-center">
              <h6 class="mb-0 font-weight-bold">
                <router-link class="text-primary" :to="{ name: 'ClientView', params: { clientId: client.id } }">
                  #{{ client.id }}
                </router-link>
              </h6>
              <div class="dropdown">
            ...
            <div class="card-body">
              <div class="client-info">
                <div class="info-row">
                  ...
                  <span class="info-value">{{ client.clientLogo }}</span>
                </div>
                <div class="info-row">
