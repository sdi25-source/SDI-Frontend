...
describe('Service Tests', () => {
  describe('Product Service', () => {
    ...
    beforeEach(() => {
      ...
      elemDefault = new Product(123, 'AAAAAAA', 'AAAAAAA', 'AAAAAAA', currentDate, currentDate);
    });
    ...
    describe('Service methods', () => {
      ...
      it('should partial update a Product', async () => {
        const patchObject = { name: 'BBBBBB', description: 'BBBBBB', updateDate: dayjs(currentDate).format(DATE_FORMAT), ...new Product() };
