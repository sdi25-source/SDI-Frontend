<template>
  <div class="product-container section pt-5">
              ...
              <td class="text-center" @click.stop>
                <div class="action-icons">
                  ...
                  <template v-else>
                    ...
                    <div class="icon-container pdf-container" @click="exportProductToPDF(product)" title="Export PDF">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="20"
                        height="20"
    ...
    <div v-if="selectedProduct && viewTabs" class="mt-4 product-detail-view" style="transition: all 2s ease">
                      ...
                      <td class="pl-5">
                        <template v-if="isEditingModuleVersion && editingModuleVersionData && editingModuleVersionData.id === module.id">
                          <select v-model="editingModuleVersionData.module" class="form-control-borderless" @click.stop>
                            <option v-for="moduleOption in selectedProduct.modules" :key="moduleOption.id" :value="{ id: moduleOption.id }">
                              {{ moduleOption.name }}
                            </option>
                          </select>
                        </template>
                    ...
                    <tr v-if="showAddModuleVersionRow" class="add-row">
                      <td class="pl-5">
                        ...
                        >
                          ...
                          <option v-for="module in selectedProduct.modules" :key="module.id" :value="{ id: module.id }">
                            {{ module.name }}
                          </option>
                        </select>
      ...
      <div class="modal-container" v-if="removeVersionEntity" role="dialog" aria-modal="true">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title text-danger">
              <svg
            ...
            <button type="button" class="close-button" @click="closeVersionDialog()" aria-label="Fermer">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="24"
                height="24"
          ...
          <div class="modal-body">
            <p>
              <strong v-text="t$('sdiFrontendApp.productVersion.delete.question', {})"></strong>
            </p>
            <p v-text="t$('entity.delete.irreversible')"></p>
          </div>
      ...
      <div class="modal-container" v-if="removeModuleEntity" role="dialog" aria-modal="true">
        <div class="modal-content">
          <div class="modal-header">
            ...
            <button type="button" class="close-button" @click="closeModuleDialog()" aria-label="Fermer">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="24"
                height="24"
          ...
          <div class="modal-body">
            <p>
              <strong v-text="t$('sdiFrontendApp.module.delete.question', {})"></strong>
            </p>
            <p v-text="t$('entity.delete.irreversible')"></p>
          </div>
      ...
      <div class="modal-container" v-if="showModuleVersionDeleteModal" role="dialog" aria-modal="true">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <p>
              <strong v-text="t$('sdiFrontendApp.moduleVersion.delete.question', {})"></strong>
            </p>
            <p v-text="t$('entity.delete.irreversible')"></p>
          </div>
          ...
          <div class="modal-footer">
            <button
              type="button"
              class="btn btn-secondary rounded-2"
              @click="closeModuleVersionDeleteModal()"
              v-text="t$('sdiFrontendApp.requestOfChange.delete.cancel')"
            ></button>
            <button
              type="button"
              class="btn btn-danger rounded-2"
              @click="confirmRemoveModuleVersion()"
              v-text="t$('sdiFrontendApp.requestOfChange.delete.delete')"
            ></button>
          </div>
        </div>
