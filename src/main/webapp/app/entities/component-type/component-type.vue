<template>
  <div class="component-type-container section pt-5">
    ...
    <!-- Card View -->
    <div v-if="componentTypes && viewMode === 'card'" class="card-view-container">
      <div class="row">
        <div v-for="componentType in paginatedComponentTypes" :key="componentType.id" class="col-md-4 col-lg-3 mb-4">
          <div class="card h-100 component-type-card">
            <div class="card-header d-flex justify-content-between align-items-center">
              <h6 class="mb-0 font-weight-bold">
                <router-link class="text-primary" :to="{ name: 'ComponentTypeView', params: { componentTypeId: componentType.id } }">
                  #{{ componentType.id }}
                </router-link>
              </h6>
              <div class="dropdown">
                <button class="btn btn-sm btn-light" @click="toggleDropdown(componentType)">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="16"
                    height="16"
                ...
                <div class="dropdown-menu dropdown-menu-right" :class="{ show: componentType.showDropdown }">
                  <a class="dropdown-item" @click="editComponentType(componentType)">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      width="16"
                      height="16"
                  ...
                  <a class="dropdown-item" @click="prepareRemove(componentType)">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      width="16"
                      height="16"
                  ...
                  <router-link class="dropdown-item" :to="{ name: 'ComponentTypeView', params: { componentTypeId: componentType.id } }">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      width="16"
                      height="16"
            ...
            <div class="card-body">
              <template v-if="componentType.isEditing">
                <div class="form-group">
                  <label>Type</label>
                  <input v-model="componentType.type" type="text" class="form-control" />
                </div>
                <div class="d-flex justify-content-end mt-3">
                  <button class="btn btn-sm btn-secondary mr-2" @click="cancelEdit(componentType)">Annuler</button>
                  <button class="btn btn-sm btn-primary" @click="saveComponentType(componentType)">Enregistrer</button>
                </div>
              </template>
              <template v-else>
                <div class="component-type-info">
                  <div class="info-row">
                    ...
                    <span class="info-value">{{ componentType.type }}</span>
                  </div>
                </div>
              </template>
            </div>
        ...
        <div v-if="showAddRow" class="col-md-4 col-lg-3 mb-4">
          <div class="card h-100 component-type-card new-card">
            <div class="card-header d-flex justify-content-between align-items-center">
            ...
            <div class="card-body">
              <div class="form-group">
                <label>Type</label>
                <input v-model="newComponentType.type" type="text" class="form-control" placeholder="Type" />
              </div>
              <div class="d-flex justify-content-end mt-3">
                <button class="btn btn-sm btn-secondary mr-2" @click="cancelNewComponentType">Annuler</button>
                <button class="btn btn-sm btn-primary" @click="saveNewComponentType">Enregistrer</button>
              </div>
            </div>
          </div>
        </div>
