  ...
  <div class="client-size-container section pt-5">
    ...
    <b-modal ref="removeEntity" id="removeEntity" centered title-class="text-danger">
      ...
      <div class="modal-body">
        <p id="jhi-delete-clientSize-heading" class="mb-0" v-text="t$('sdiFrontendApp.clientSize.delete.question', { id: removeId })"></p>
      </div>
...
/* Reprenez les mêmes styles que dans ComponentType.vue en adaptant les noms de classe */
