        ...
        <div class="col-lg-6">
          <div class="hero-content" data-aos="fade-up" data-aos-delay="200">
            <div class="company-badge mb-4">
              <img src="../../../../content/images/s2m.svg" alt="DM Icon" style="width: 60px; height: 40px; margin-right: 8px" />
              <span v-text="t$('home.di')"></span>
            </div>
            <h1 class="mb-4">
              <span>Welcome, </span><span class="accent-text">{{ username }}</span> <br />
              <span>to your Delivery</span> <br />
              <span>Manager Space</span>
            </h1>
            <p class="mb-4 mb-md-5" v-text="t$('home.equipeDdesc')"></p>
          </div>
        </div>
        <div class="col-lg-6">
...
<script lang="ts" src="./dm-home.component.ts"></script>
