  ...
  <div class="user-management-container section pt-5">
    <div class="navigation-bar d-flex align-items-center justify-content-between mb-4">
      <div class="d-flex align-items-center">
        ...
        >
          <span v-text="t$('userManagement.home.new')"></span>
        </button>
            ...
            <tr v-for="user in users" :key="user.id" :id="user.login" data-cy="entityTable" class="align-middle">
              ...
              <td>
                <div v-for="authority in user.authorities" :key="authority">
                  <span class="badge bg-info text-dark rounded-2">{{ authority }}</span>
                </div>
              </td>
              <td>
              ...
              <td class="text-center">
                <div class="action-icons">
                  <div class="icon-container view-container" @click="openDetailsModal(user.login)" title="Voir">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      width="16"
                      height="16"
                  ...
                  <div class="icon-container edit-container" @click="openEditModal(user.login)" title="Modifier">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      width="16"
                      height="16"
